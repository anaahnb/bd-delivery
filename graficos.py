...
plt.bar(df_vendas['restaurante_nome'], df_vendas['total_vendas'], color='skyblue')
...
plt.bar(df_pedidos_restaurante['restaurante_nome'], df_pedidos_restaurante['num_pedidos'], color='lightgreen')
